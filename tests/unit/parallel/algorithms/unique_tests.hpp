...
void test_unique(ExPolicy policy, IteratorTag, DataType, Pred pred,
    int rand_base)
{
    static_assert(
    ...
    auto result = hpx::parallel::unique(policy,
...
template <typename ExPolicy, typename IteratorTag, typename DataType, typename Pred>
void test_unique_async(ExPolicy policy, IteratorTag, DataType, Pred pred,
    int rand_base)
{
    static_assert(
        hpx::parallel::execution::is_execution_policy<ExPolicy>::value,
    ...
    auto f = hpx::parallel::unique(policy,
        iterator(std::begin(c)), iterator(std::end(c)), pred);
    auto result = f.get();
    auto solution = std::unique(std::begin(d), std::end(d), pred);
...
void test_unique_etc(ExPolicy policy, IteratorTag,
...
void test_unique()
{
    ...
    test_unique(execution::seq, IteratorTag(), int(),
        [](const int a, const int b) -> bool {
            return a == b;
        }, rand_base);
    test_unique(execution::par, IteratorTag(), int(),
        [rand_base](const int a, const int b) -> bool {
            return a == b && b == rand_base;
        }, rand_base);
    test_unique(execution::par_unseq, IteratorTag(), int(),
        [](const int a, const int b) -> bool {
            return a == b;
        }, rand_base);

    ////////// Test cases for user defined type.
    test_unique(execution::seq, IteratorTag(), user_defined_type(),
        [](user_defined_type const& a, user_defined_type const& b) -> bool {
            return a == b;
        }, rand_base);
    test_unique(execution::par, IteratorTag(), user_defined_type(),
        [](user_defined_type const& a, user_defined_type const& b) -> bool {
            return a == b;
        }, rand_base);
    test_unique(execution::par_unseq, IteratorTag(), user_defined_type(),
        [rand_base](user_defined_type const& a, user_defined_type const& b) -> bool {
            return a == b && b == rand_base;
        }, rand_base);

    ////////// Asynchronous test cases for 'int' type.
    test_unique_async(execution::seq(execution::task), IteratorTag(), int(),
        [rand_base](const int a, const int b) -> bool {
            return a == b && b == rand_base;
        }, rand_base);
    ...
    test_unique_async(execution::seq(execution::task), IteratorTag(),
        user_defined_type(),
        [](user_defined_type const& a, user_defined_type const& b) -> bool {
            return a == b;
        }, rand_base);
    test_unique_async(execution::par(execution::task), IteratorTag(),
        user_defined_type(),
        [rand_base](user_defined_type const& a, user_defined_type const& b) -> bool {
    ...
    test_unique_etc(execution::seq, IteratorTag(),
...
void test_unique_exception()
{
    ...
    test_unique_exception_async(execution::seq(execution::task),
        IteratorTag());
    test_unique_exception_async(execution::par(execution::task),
        IteratorTag());
}
...
void test_unique_bad_alloc()
{
    ...
    test_unique_bad_alloc_async(execution::seq(execution::task),
        IteratorTag());
    test_unique_bad_alloc_async(execution::par(execution::task),
        IteratorTag());
}
